...
include(":instrumentation:eclipse-milo-0.6:client:javaagent")
include(":instrumentation:eclipse-milo-0.6:client:testing")
include(":instrumentation:eclipse-milo-0.6:server:javaagent")
include(":instrumentation:eclipse-milo-0.6:server:testing")
